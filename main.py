        ...
        with st.sidebar.expander("Help & Instructions"):
            st.markdown("""
                **How to use this dashboard:**
                1. Use the category filter above to focus on specific case types
                2. Use the search bar to find specific issues
                3. Click on any case to expand details
                4. Export summaries using the export button
            """)
