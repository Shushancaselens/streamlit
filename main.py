                            ...
                            evidenceHtml = `
                                ...
                                <div class="card-detail-value">
                                    <div style="font-size: 13px; color: #4a5568; margin-bottom: 12px; font-style: italic; background-color: #f8fafc; padding: 8px; border-radius: 4px; border-left: 3px solid #dd6b20;">
                                        This fact is supported by ${{evidenceContent.length}} piece${{evidenceContent.length > 1 ? 's' : ''}} of documentary evidence, including ${{evidenceContent.map(e => e.title.toLowerCase()).join(', ')}}. Click on each evidence item below to view detailed descriptions.
                                    </div>
                                            ...
                                            <div id="evidence-content-${{evidence.id}}-${{index}}-${{evidenceIndex}}" 
                                                ...
                                                <div style="margin-bottom: 12px;">
                                                    ...
                                                    <div style="margin-top: 8px; font-size: 11px; color: #718096;">
                                                        <div>Page: ${{fact.page || 'N/A'}} | Paragraphs: ${{fact.paragraphs || 'N/A'}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                function renderTimeline(tabType = 'all') {{
                    ...
                    filteredData.forEach(fact => {{
                        ...
                        if (fact.source_text && fact.source_text !== 'No specific submission recorded' && 
                            ...
                            sourceTextEl.innerHTML = `Source Text:<br>${{fact.source_text}}`;
                        ...
                        const claimantSubmissionText = fact.claimant_submission && fact.claimant_submission !== 'No specific submission recorded' 
                            ? fact.claimant_submission 
                            : 'No submission provided';
                        claimantTextEl.innerHTML = `Claimant Submission:<br><span style="${{fact.claimant_submission && fact.claimant_submission !== 'No specific submission recorded' ? '' : 'font-style: italic; color: #9ca3af;'}}">${{claimantSubmissionText}}</span>`;
                        ...
                        const respondentSubmissionText = fact.respondent_submission && fact.respondent_submission !== 'No specific submission recorded' 
                            ? fact.respondent_submission 
                            : 'No submission provided';
                        respondentTextEl.innerHTML = `Respondent Submission:<br><span style="${{fact.respondent_submission && fact.respondent_submission !== 'No specific submission recorded' ? '' : 'font-style: italic; color: #9ca3af;'}}">${{respondentSubmissionText}}</span>`;
                    ...
                    filteredFacts.forEach((fact, index) => {{
                        ...
                        if (evidenceContent !== 'None') {{
                            evidenceHtml = `
                                ...
                                <div class="card-detail-value">
                                    <div style="font-size: 13px; color: #4a5568; margin-bottom: 12px; font-style: italic; background-color: #f8fafc; padding: 8px; border-radius: 4px; border-left: 3px solid #dd6b20;">
                                        Source Text: This fact is supported by ${{evidenceContent.length}} piece${{evidenceContent.length > 1 ? 's' : ''}} of documentary evidence, including ${{evidenceContent.map(e => e.title.toLowerCase()).join(', ')}}. Click on each evidence item below to view detailed descriptions.
                                    </div>
                                    ${{evidenceContent.map((evidence, evidenceIndex) => `
                                        <div style="margin-bottom: 12px; border: 1px solid #e2e8f0; border-radius: 6px; overflow: hidden;">
                                            <div onclick="toggleEvidence('${{evidence.id}}', '${{index}}-${{evidenceIndex}}')" 
