...
with tab1:
    ...
    st.markdown("<div class='minimal-filter-container'>", unsafe_allow_html=True)
    st.markdown("<div class='minimal-filter-row'>", unsafe_allow_html=True)
    
    # Party filters - no labels, just buttons
    st.markdown("<div class='minimal-filter-group'>", unsafe_allow_html=True)
    col1, col2, col3 = st.columns([0.8, 0.8, 0.8], gap="small")
    ...
    with col1:
        if st.button("Both", use_container_width=True, key="both1"):
            st.session_state.party_selection = "Both Parties"
    with col2:
        if st.button("Appellant", use_container_width=True, key="appellant1"):
            st.session_state.party_selection = "Appellant Only"
    with col3:
        if st.button("Respondent", use_container_width=True, key="respondent1"):
    ...
    # View mode - no labels, just buttons  
    st.markdown("<div class='minimal-filter-group'>", unsafe_allow_html=True)
    col4, col5 = st.columns([0.8, 0.8], gap="small")
    ...
    with col4:
        if st.button("Table", use_container_width=True, key="table1"):
            st.session_state.view_mode_selection = "Table View"
    with col5:
        if st.button("Documents", use_container_width=True, key="docs1"):
...
with tab2:
    ...
    with col1:
        if st.button("Both", use_container_width=True, key="both2"):
            st.session_state.party_selection_tab2 = "Both Parties"
    with col2:
        if st.button("Appellant", use_container_width=True, key="appellant2"):
            st.session_state.party_selection_tab2 = "Appellant Only"
    with col3:
        if st.button("Respondent", use_container_width=True, key="respondent2"):
    ...
    with col4:
        if st.button("Timeline", use_container_width=True, key="timeline2"):
            st.session_state.view_mode_selection_tab2 = "All Facts Together"
    with col5:
        if st.button("Documents", use_container_width=True, key="docs2"):
