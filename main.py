        ...
        <div class="container">
            ...
            <div id="arguments" class="content-section">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 16px;">
                    <div>
                        <button onclick="window.togglePartyView('both')" id="both-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #4299e1; color: white; cursor: pointer; margin-right: 5px;">Both Parties</button>
                        
                        <button onclick="window.togglePartyView('appellant')" id="app-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #f7fafc; color: black; cursor: pointer; margin-right: 5px;">Appellant Only</button>
                        
                        <button onclick="window.togglePartyView('respondent')" id="resp-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #f7fafc; color: black; cursor: pointer;">Respondent Only</button>
                    </div>
                    <div>
