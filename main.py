// Render document sets view with table-like evidence formatting
                function renderDocumentSets(tabType = 'all') {
                    ...
                    Object.values(docsWithFacts).forEach(docWithFacts => {
                        ...
                        if (facts.length > 0) {
                            ...
                            // Add each fact row separately to avoid nested template issues
                            facts.forEach((fact, factIndex) => {
                                ...
                                if (evidenceContent === 'None') {
                                    ...
                                    contentHtml += '<div>';
                                    evidenceContent.forEach((evidence, evidenceIndex) => {
                                        contentHtml += `
                ...
                function renderFacts(type = 'all') {
                    ...
                    filteredFacts.forEach(fact => {
                        ...
                        // Evidence column - moved to appear right after Source Text
