            ...
            <script>
                    ...
                    filteredFacts.forEach((fact, index) => {
                        ...
                        docSection.innerHTML = `
                            ...
                            <div class="card-detail-value">
                                <strong>${createDocumentLink(fact.doc_name)}</strong>
                ...
                function renderTimeline(tabType = 'all') {
                    ...
                    filteredData.forEach(fact => {
                        ...
                        // Document and reference information section with clickable document link
                        ...
                        docInfoEl.innerHTML = `
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 13px;">
                                <div><strong>Document:</strong> ${createDocumentLink(fact.doc_name)}</div>
                ...
                function renderDocumentSets(tabType = 'all') {
                    ...
                    Object.values(docsWithFacts).forEach(docWithFacts => {
                        ...
                        if (facts.length > 0) {
                            // Create a single table for all facts in this category - with improved evidence formatting and clickable document links
                            contentHtml += `
                                <div class="table-view-container">
                                    <table class="table-view">
                                        <thead>
                                        ...
                                        <tbody>
                                            ${facts.map((fact, factIndex) => `
                                                <tr ${fact.isDisputed ? 'class="disputed"' : ''}>
                                                    ...
                                                    <td style="max-width: 250px; font-weight: 500; word-wrap: break-word;">${createDocumentLink(fact.doc_name)}</td>
                ...
                function renderFacts(type = 'all') {
                    ...
                    filteredFacts.forEach(fact => {
                        ...
                        // Document column with clickable link
                        const docCell = document.createElement('td');
                        docCell.innerHTML = createDocumentLink(fact.doc_name);
