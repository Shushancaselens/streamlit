        ...
        <div class="container">
            ...
            <div id="arguments" class="content-section">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 16px;">
                    <div>
                        <button onclick="document.querySelector('.argument-table').className='argument-table'; document.getElementById('both-btn').style.backgroundColor='#4299e1'; document.getElementById('both-btn').style.color='white'; document.getElementById('app-btn').style.backgroundColor='#f7fafc'; document.getElementById('app-btn').style.color='black'; document.getElementById('resp-btn').style.backgroundColor='#f7fafc'; document.getElementById('resp-btn').style.color='black'; document.querySelectorAll('.arguments-row').forEach(row => { if(row.children.length === 2) { row.children[0].style.display=''; row.children[1].style.display=''; row.style.gridTemplateColumns='1fr 1fr'; } }); document.querySelectorAll('.appellant-color').forEach(h => h.style.display=''); document.querySelectorAll('.respondent-color').forEach(h => h.style.display='');" id="both-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #4299e1; color: white; cursor: pointer; margin-right: 5px;">Both Parties</button>
                        
                        <button onclick="document.querySelector('.argument-table').className='argument-table appellant-only'; document.getElementById('app-btn').style.backgroundColor='#4299e1'; document.getElementById('app-btn').style.color='white'; document.getElementById('both-btn').style.backgroundColor='#f7fafc'; document.getElementById('both-btn').style.color='black'; document.getElementById('resp-btn').style.backgroundColor='#f7fafc'; document.getElementById('resp-btn').style.color='black'; document.querySelectorAll('.arguments-row').forEach(row => { if(row.children.length === 2) { row.children[0].style.display=''; row.children[1].style.display='none'; row.style.gridTemplateColumns='1fr'; } }); document.querySelectorAll('.appellant-color').forEach(h => h.style.display=''); document.querySelectorAll('.respondent-color').forEach(h => h.style.display='none');" id="app-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #f7fafc; cursor: pointer; margin-right: 5px;">Appellant Only</button>
                        
                        <button onclick="document.querySelector('.argument-table').className='argument-table respondent-only'; document.getElementById('resp-btn').style.backgroundColor='#4299e1'; document.getElementById('resp-btn').style.color='white'; document.getElementById('both-btn').style.backgroundColor='#f7fafc'; document.getElementById('both-btn').style.color='black'; document.getElementById('app-btn').style.backgroundColor='#f7fafc'; document.getElementById('app-btn').style.color='black'; document.querySelectorAll('.arguments-row').forEach(row => { if(row.children.length === 2) { row.children[0].style.display='none'; row.children[1].style.display=''; row.style.gridTemplateColumns='1fr'; } }); document.querySelectorAll('.appellant-color').forEach(h => h.style.display='none'); document.querySelectorAll('.respondent-color').forEach(h => h.style.display='');" id="resp-btn" style="padding: 8px 16px; border: 1px solid #e2e8f0; background-color: #f7fafc; cursor: pointer;">Respondent Only</button>
                    </div>
                    <div>
