...
def main():
    # Create logo SVG
    logo_svg = """
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175 175" style="width: 50px; height: 50px; margin-bottom: 1rem;">
    ...
    with st.sidebar:
        ...
        st.markdown(f"""
            <div style="display: flex; align-items: center; margin-bottom: 2rem;">
                {logo_svg}
                <h1 style="margin-left: 1rem; margin-bottom: 0;">Legal Hub</h1>
            </div>
        """, unsafe_allow_html=True)
